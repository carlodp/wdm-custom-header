...
(function($) {
    ...
    function bindEvents() {
        ...
        $(document).on('click', '.wdm-toggle-submenu', function() {
            ...
            $(this).html(isHidden ? '<i class="fas fa-chevron-down"></i> Show Submenu (' + $submenu.find('.wdm-submenu-item').length + ')' : '<i class="fas fa-chevron-up"></i> Hide Submenu');
        });
    ...
    function updateSubmenuIndices() {
        ...
        $('.wdm-menu-item').each(function() {
            ...
            $toggle.html(isHidden ? '<i class="fas fa-chevron-down"></i> Show Submenu (' + submenuCount + ')' : '<i class="fas fa-chevron-up"></i> Hide Submenu');
        });
    }
    ...
    function toggleSubmenuVisibility() {
        $('.wdm-menu-item').each(function() {
            ...
            $toggle.html('<i class="fas fa-chevron-down"></i> Show Submenu (' + submenuCount + ')');
        });
    }

 ...
 * Standalone admin page for managing header settings
 */

// Load WordPress functions fallback
require_once 'includes/wordpress-functions.php';

// Initialize session for storing settings
session_start();
...
<body>
    <div class="container">
        <a href="/" class="back-link">← Back to Header</a>
                                ...
                                <div class="item-content">
                                    <table class="form-table">
                                        <tr>
                                            <th>Title</th>
                                            <td>
                                                <input type="text" name="menu_items[<?php echo $index; ?>][title]" value="<?php echo htmlspecialchars($item['title']); ?>" class="form-control" required>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>URL</th>
                                            <td>
                                                <input type="text" name="menu_items[<?php echo $index; ?>][url]" value="<?php echo htmlspecialchars($item['url']); ?>" class="form-control" required>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Has Dropdown</th>
                                            <td>
                                                <label>
                                                    <input type="checkbox" name="menu_items[<?php echo $index; ?>][has_dropdown]" value="1" <?php echo !empty($item['has_dropdown']) ? 'checked' : ''; ?> onchange="toggleDropdown(this)">
                                ...
                                <div class="item-content">
                                    <table class="form-table">
                                        <tr>
                                            <th>Label</th>
                                            <td>
                                                <input type="text" name="utility_buttons[<?php echo $index; ?>][label]" value="<?php echo htmlspecialchars($button['label']); ?>" class="form-control" required>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>URL</th>
                                            <td>
                                                <input type="text" name="utility_buttons[<?php echo $index; ?>][url]" value="<?php echo htmlspecialchars($button['url']); ?>" class="form-control" required>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>CSS Class</th>
    ...
    <script>
                ...
                <div class="menu-item">
                    ...
                    <div class="item-content" style="display: block;">
                        <table class="form-table">
                            <tr>
                                <th>Title</th>
                                <td><input type="text" name="menu_items[${index}][title]" value="" class="form-control" required></td>
                            </tr>
                            <tr>
                                <th>URL</th>
                                <td><input type="text" name="menu_items[${index}][url]" value="" class="form-control" required></td>
                            </tr>
                            <tr>
                                <th>Has Dropdown</th>
                                <td>
                                    <label>
                                        <input type="checkbox" name="menu_items[${index}][has_dropdown]" value="1" onchange="toggleDropdown(this)">
                                        Enable mega dropdown menu
                                    </label>
                                </td>
                            </tr>
                ...
                <div class="utility-button">
                    ...
                    <div class="item-content" style="display: block;">
                        <table class="form-table">
                            <tr>
                                <th>Label</th>
                                <td><input type="text" name="utility_buttons[${index}][label]" value="" class="form-control" required></td>
                            </tr>
                            <tr>
                                <th>URL</th>
                                <td><input type="text" name="utility_buttons[${index}][url]" value="" class="form-control" required></td>
                            </tr>
                            <tr>
                                <th>CSS Class</th>
                                <td><input type="text" name="utility_buttons[${index}][class]" value="" class="form-control"></td>
                            </tr>
                            <tr>
                                <th>Target</th>
                                <td>
                                    <select name="utility_buttons[${index}][target]" class="form-control">
                            ...
                            <tr>
                                <th>Visibility</th>
                                <td>
                                    <select name="utility_buttons[${index}][visibility]" class="form-control">
        ...
        function toggleDropdown(checkbox) {
            // Implementation for toggling dropdown section
            console.log('Dropdown toggle clicked');
        }
        
        function addDropdownItem(button) {
            // Implementation for adding dropdown items
            console.log('Add dropdown item clicked');
        }
